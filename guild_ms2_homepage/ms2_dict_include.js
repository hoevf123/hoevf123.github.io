...
let ms2_bgm_records = [
    ...
    ['Spring Breeze / Forest Stacatto', '헤네시스', 'BGM_Henesys_01.mp3', ['./Maplestory2/BGM/BGM_Henesys_01.mp3',"https://soundcloud.com/maplestory2/bgm-henesys-01"]],
    ...
    ['Dreaming Sailor / Wind of Adventure', '리스항구', 'BGM_Lith_01.mp3', ['./Maplestory2/BGM/BGM_Lith_01.mp3','https://soundcloud.com/maplestory2/dreaming-sailor']],
    ...
    ['Energetic Wave', '결혼식장 - 럭셔리 웨딩 크루즈', 'BGM_LuxuryCruiseWedding_01.mp3', './Maplestory2/BGM/BGM_LuxuryCruiseWedding_01.mp3'],
    ...
    ['', '머쉬킹 챔피언십 인트로', 'BGM_YOYO_Intro_01.mp3', './Maplestory2/BGM/BGM_YOYO_Intro_01.mp3'],
    ['', '머쉬킹 챔피언십 - 태초의 버섯 섬 경기 대기', 'BGM_YOYO_Lobby_01.mp3', './Maplestory2/BGM/BGM_YOYO_Lobby_01.mp3'],
    ['', '머쉬킹 챔피언십 - 태초의 버섯 섬', 'BGM_YOYO_Loop_01.mp3', './Maplestory2/BGM/BGM_YOYO_Loop_01.mp3'],
    ...
    ['메투난다', '(Youtube)메이플2 리스타트',["MS2_MV.mp3","MS2_MV_MR.mp3"], ["https://youtu.be/WHNwjph_r5g",'http://maple2.vod.nexoncdn.co.kr/ost/21_MS2_MV_AR.mp3']],
...
let ms2_custom_palletes_origin_records=[
    ...
    ["디자인 큐브", "./Maplestory2/Custom/Cube/template_design_cube.png"],
    ["디자인 함정 큐브", "./Maplestory2/Custom/Cube/template_design_cube.png"],
    ["디자인 회전 큐브", "./Maplestory2/Custom/Cube/template_design_cube.png"],

    //default design scheme in the MS2(Ridee)
    ["디자인 미니밴", "./Maplestory2/Custom/Ridee/template_minivan.png"],
    ["디자인 지프", "./Maplestory2/Custom/Ridee/template_jeep.png"],
    ["디자인 에퀴리아", "./Maplestory2/Custom/Ridee/template_equirria.png"],
    ["디자인 네이키드 비스트", "./Maplestory2/Custom/Ridee/template_naked_beast.png"],
    ["디자인 보니토", "./Maplestory2/Custom/Ridee/template_bonito.png"],
    ["디자인 인티모", "./Maplestory2/Custom/Ridee/template_intimo.png"],
    ["디자인 포크레인(굴착기)", "./Maplestory2/Custom/Ridee/template_excavator.png"],
    ["디자인 레이싱 머신", "./Maplestory2/Custom/Ridee/template_racing_machine.png"],
    ["디자인 홍보 트럭"] //not found default template file.
];
...
let ms2_custom_palletes_paint_optimized_records=[
    ...
    ["디자인 두루마리 큐브", "./Maplestory2/Custom/Cube/디자인 두루마리 큐브.png"],
    ["디자인 바 테이블 큐브", "./Maplestory2/Custom/Cube/디자인 바 테이블 큐브.png"],
    ["디자인 사다리꼴 큐브", "./Maplestory2/Custom/Cube/디자인 사다리꼴 큐브.png"],
    ["디자인 카드 큐브", "./Maplestory2/Custom/Cube/디자인 카드 큐브.png"],
    ["디자인 칸막이 큐브", "./Maplestory2/Custom/Cube/디자인 칸막이 큐브.png"],
    ["디자인 큐브", "./Maplestory2/Custom/Cube/디자인 큐브.png"],
    ["디자인 파티션 큐브", "./Maplestory2/Custom/Cube/디자인 파티션 큐브.png"],
];
