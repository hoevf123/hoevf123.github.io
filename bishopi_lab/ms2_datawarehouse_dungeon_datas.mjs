...
export const temp_dungeon_datas = [
    ...
    // 60 Chaos Raid (was 54-56 dungeons)
    {
        ...
        "isRankInfoUpdatable":true,
        "isRankSearchable":true,
        "representiveBossMonster" : {monsterLevel: 60,monsterId: 23200067, monsterName: "비에른", thumbnailImage: MAPLESTORY2_IMAGEPORTRAIT_DIR + "mob/23000083_b_snowking_p.png" },
    },
    {
        "dungeonType": "카오스 레이드",
        "dungeonName": "마드라칸 첨탑",
        ...
        "isRankInfoUpdatable":true,
        "isRankSearchable":true,
        "representiveBossMonster" : {monsterLevel: 60,monsterId: 23000114, monsterName: "루카락스", thumbnailImage: MAPLESTORY2_IMAGEPORTRAIT_DIR + "mob/23000064_b_bigwingchimera_p.png" },
    },
    {
...
export const additionalOptionsPickSets = {
    "headgear":[
        { name: 'STR', probability: 0.029412, optionGroup : "YellowGroup", values : [
            {value : 1.3, revealRate : 12.5},
            {value : 1.3, revealRate : 12.5},
            {value : 1.4, revealRate : 12.5},
            {value : 1.4, revealRate : 12.5},
            {value : 1.5, revealRate : 12.5},
            {value : 1.5, revealRate : 12.5},
            {value : 1.6, revealRate : 12.5},
            {value : 1.6, revealRate : 12.5},
        ]},
        ...
        { name: '보스 몬스터 공격 시 대미지 증가', probability: 0.029412 , optionGroup : "YellowGroup", values : [
            {value : 1.3, revealRate : 12.5},
            {value : 1.3, revealRate : 12.5},
            {value : 1.4, revealRate : 12.5},
            {value : 1.4, revealRate : 12.5},
...
export const gearItems = {
    "firePrismSceptor":{
        ...
        "itemName":"파이어 프리즘 홀",
        "basicOptions" : [
            {"itemName": "criticalHit", value : 10, "valueType" : "number"},
            {"itemName": "HP", value : 100, "valueType" : "number"},
            {"itemName": "magicAttack", value : 8, "valueType" : "number"},
            {"itemName": "defensePiercing", value : 10, "valueType" : "percent"},
        ],
        "additionalOptionLines": 3,
        "additionalOptionPickSet" : additionalOptionsPickSets.weapon
    }
};
