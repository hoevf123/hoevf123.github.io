     ...
     <!-- Content Header -->
       ...
       <div class="search-bar-board-content">
        ...
        try{
        	...
        	/* 게시물의 개수를 확인하는 코드 */
        	String sqlCount = "SELECT COUNT(*) FROM board where page_type='공지사항'";
        	...
        	/* 게시물의 내용을 확인하는 코드 */
	       	String sqlList = "SELECT page_no, page_title, page_author, page_write_date, page_hit, page_id FROM board where page_type='공지사항' order by page_id desc;";
